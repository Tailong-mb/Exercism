...
public class Say {
    ...
    public String say(long number) {
        ...
        for (Magnitude magnitude: supportedMagnitudes) { 
            double quotient = Math.floor(number / magnitude.getNumber());
            Part part = new Part((int) quotient, magnitude);
    ...
    private static class Part {
        ...
        private static String[] oneToTwenty = { "zero", "one", "two", "three", "four", "five", "six", "seven", "eigth",
        ...
        private String say() {
            ...
            if (hundreds > 0) {
                stringBuffer.append(OneToTwenty[hundreds]).append(" hundred");
            }
            ...
            if (tens >= 20) {
                ...
                if (tens % 10 > 0) {
                    stringBuffer.append("-").append(OneToTwenty[tens % 10]);
                }
            } else {
                stringBuffer.append(OneToTwenty[tens]);
            }
